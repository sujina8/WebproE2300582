...
echo '<p style="margin-top:20px"><a href="../admin/login.php" style="background:#16a34a;color:white;padding:10px 20px;border-radius:8px;text-decoration:none">Go to Admin Login →</a></p>';
echo '</div>';
?>
